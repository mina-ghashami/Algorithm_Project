...
% Import data files
D_DATAFILE = 'Data/gisette/gisette_train.data';
...
disp('Results: K-Means on Gisette w/out PCA');
km = kmeans(DRV_D,K);
...
% Compare Results
disp('Results: Comparing Results of 2-Dim Reduction vs. No Reduction on Gisette with K-Means');
evaluateACMI(km, kmpca_2)
newRI(km, kmpca_2, m)

disp('Results: Comparing Results of 6-Dim Reduction vs. No Reduction on Gisette with K-Means');
evaluateACMI(km, kmpca_6)
newRI(km, kmpca_6, m)

disp('Results: Comparing Results of 10-Dim Reduction vs. No Reduction on Gisette with K-Means');
...
disp('Results: DBScan on Gisette w/out PCA');
