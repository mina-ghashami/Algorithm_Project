function [eigvector, eigvalue, elapse,mem] = LPP(W, options, data)
...
if ~isfield(options,'Regu') | ~options.Regu
    ...
    [eigvector, eigvalue, elapse,mem] = LGE(W, [], options, data);
else
    ...
    if bGlobal & isfield(options,'keepMean') & options.keepMean
        [eigvector, eigvalue, elapse,mem] = LGE(W, D, options);
    else
        [eigvector, eigvalue, elapse,mem] = LGE(W, D, options, data);
    end
end
